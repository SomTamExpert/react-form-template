import {Alert, Button, Col, Form, OverlayTrigger, Row, Tooltip, ProgressBar, Badge, Accordion, ListGroup} from "react-bootstrap";
...
const BodyMassIndexWithForms = () => {
    ...
    return (
        ...
        <Alert.Heading className="mt-0">Herzlichen Dank für Ihre Teilnahme</Alert.Heading>
                    <p>
                    <Alert.Link href="https://de.wikipedia.org/wiki/Body-Mass-Index"> Wikipedia - Body-Mass-Index</Alert.Link> finden Sie weiterführende Informationen
                    </p>
                    <hr/>
                    <p className="mb-0">
                        Bemerkung: Der Rechner benutzt JavaScript. Wenn Sie JavaScript abgeschaltet haben könnte es zu Problemen mit dem Formular kommen.
                    </p>
                    <div className="d-flex justify-content-end">
                        <Button className="SubmitButton" onClick={() => setShowAlert(false)}>Schliessen</Button>
                    </div>
        </Alert>
        <div className="Wrapper">
            <div>
                <h1 id="title">Body Mass Index Calculator <Badge variant="secondary">v.2.0</Badge></h1>
            </div>
            
            <Form className="BmiForm" noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="text" value={firstName} placeholder="Hans" onChange={(event) => handleFirstName(event)}></Form.Control>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="text" value={lastName} placeholder="Muster" onChange={(event) => handleLastName(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="text" value={email} placeholder="hans.muster@muster.com" onChange={(event) => handleEmail(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
             ...
             <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="text" value={location} placeholder="Zürich" onChange={(event) => handleLocation(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="number" value={zipCode}  placeholder="8001" onChange={(event) => handleZipCode(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                    <Form.Select required value={canton} onChange={(event) => handleCanton(event)}>
                      <option></option>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="number" value={weight}  step={0.5} precision={2} placeholder="80" onChange={(event) => handleWeight(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm="10">
                        <Form.Control required type="number" value={height}  step={0.01} precision={2} placeholder="1.75" onChange={(event) => handleHeight(event)}></Form.Control>
                        <Form.Control.Feedback>sieht gut aus!</Form.Control.Feedback>
                    </Col>
                </Form.Group>
                        ...
                        <OverlayTrigger
                          ...
                          >
                            <Button               
                                className="SubmitButton"
                                type="submit"
                                onClick={handleDelte}>Werte löschen     
                            </Button>
                          </OverlayTrigger>
                        </Col>
                    </Form.Group>
        ...
        <div className="BMIContainer" ref={myRef}>
          ...
          <div className="Result" >
            Ihr BMI beträgt:
          <ProgressBar animated now={bmi} label={`${bmi}`} min="14" max="36"/>
          </div>
